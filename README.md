...
The study will include a case study of different examples for each of the models to provide an explanation of why the models/metrics have the biases that was found in the study.
